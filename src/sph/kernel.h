                                      ...
                                      vectorclass::Vec4d *dwk)
{
  ...
  vectorclass::Vec4db decision = (u < 0.5);
  vectorclass::Vec4d wksub     = 6.0 * u;

  vectorclass::Vec4d ucompsq = ucompl * ucompl;
  vectorclass::Vec4d uucomp  = u * ucompl;
  vectorclass::Vec4d wk1     = 1.0 + uucomp * wksub;
