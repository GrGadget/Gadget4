...
#include "../logs/logs.h"   // extern class Logs; enum logs
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::primary_loop(int mode)
{
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::secondary_loop(void)
{
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::set_MaxNexport(const char *file, int line)
{
  ...
  MinSpace =
      (D->NTask - 1) * (sizeof(data_partlist) + sizeof(T_in) + sizeof(T_out)) + D->NTopleaves * (sizeof(data_nodelist) + sizeof(int));
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_alloc_partlist_nodelist_ngblist_threadbufs(void)
{
  Thread.Nexport      = 0;
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_free_partlist_nodelist_ngblist_threadbufs(void)
{
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_prepare_export_counts(void)
{
 ...
 */
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_prepare_import_counts(void)
{
 ...
 */
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_prepare_export_offsets(void)
{
  Send_offset[0]       = 0;
 ...
 */
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_prepare_particle_data_for_export(void)
{
 ...
 */
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_add_results_to_local(void)
{
  for(int j = 0; j < D->NTask; j++)
    Send[j].Count = 0;
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_multiple_phases(void)
{
  int ncycles;
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_exchange(void)
{
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_allocate_comm_tables(void)
{
  ptrdiff_t off;
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_free_comm_tables(void)
{
 ...
 */
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
int generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::execute(int nactive, int *targetlist, int action)
{
...
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
int generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::execute(int nactive, int *targetlist, int action, enum logs::timers a,
                                                                    enum logs::timers b, enum logs::timers c)
{
  cpu_primary   = a;
  cpu_secondary = b;
  cpu_imbalance = c;
 ...
 */
template <typename T_in, typename T_out, typename T_tree, typename T_domain, typename T_partset>
void generic_comm<T_in, T_out, T_tree, T_domain, T_partset>::generic_get_numnodes(int target, int *numnodes, node_info **firstnode)
{
  if(target == Nimport - 1)
